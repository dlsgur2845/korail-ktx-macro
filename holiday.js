(() => {
  ...
  function controls(){for(const id of ['pick','target','sync','arm'])get(id).disabled=!!armed||syncing;get('cancel').disabled=!armed;}
  function point(){
